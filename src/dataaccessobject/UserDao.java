...
public class UserDao {
    ...
    public static void save(Users user) {
        ...
        DataBaseOperations.setDataOrDelete(query, "Registered Successfully !  Wait For Admin To Approve. ");
    }
    ...
    public static Users getSecurityQuestion(String email) {
        Users user = null;
        try {
            ResultSet rs = DataBaseOperations.getData("select * from user where email = '" + email + "'");
            while (rs.next()) {
                user = new Users();
    ...
    public static void update(String email, String newPassword) {
        ...
        DataBaseOperations.setDataOrDelete(query, " Password Change Successfully ");
    }

    public static ArrayList<Users> getAllRecords(String email) {
    ...
    public static void changeStatus(String email, String status) {
        String quey = "update user set status='" + status + "' where email = '" + email + "'";
        DataBaseOperations.setDataOrDelete(quey, "Status Changed Successfully");
    }
    ...
    public static void update(String email, String securityQuestion, String answer){
        ...
        DataBaseOperations.setDataOrDelete(query, " Security Question Updated Successfully ! ");
    } 
