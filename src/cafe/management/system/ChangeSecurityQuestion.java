...
public class ChangeSecurityQuestion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(756, 16, -1, -1));
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 140, 200, -1));
        ...
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 240, 200, -1));
        ...
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 290, 200, -1));
        ...
        getContentPane().add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 290, 301, -1));

        txtNewAnswer.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        txtNewAnswer.setForeground(new java.awt.Color(102, 51, 0));
        txtNewAnswer.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtNewAnswerKeyReleased(evt);
            }
        });
        getContentPane().add(txtNewAnswer, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 240, 301, -1));

        txtNewSQ.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        txtNewSQ.setForeground(new java.awt.Color(102, 51, 0));
        txtNewSQ.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtNewSQKeyReleased(evt);
            }
        });
        getContentPane().add(txtNewSQ, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 190, 301, -1));

        txtOldSQ.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        txtOldSQ.setForeground(new java.awt.Color(102, 51, 0));
        getContentPane().add(txtOldSQ, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 140, 301, -1));
        ...
        getContentPane().add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 350, -1, -1));

        jButton3.setBackground(new java.awt.Color(255, 226, 187));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 350, -1, -1));

        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/HOME (2).png"))); // NOI18N
