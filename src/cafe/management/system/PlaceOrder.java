...
public class PlaceOrder extends javax.swing.JFrame {
    ...
    public void validateFields() {
        ...
        if (!customerEmail.equals("") && customerEmail.matches(emailPattern) && customerMobileNumber.matches(mobileNumberPattern) && customerMobileNumber.length() == 10 && grandTotal > 0) {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(25, 23, 192, -1));

        jButton1.setBackground(new java.awt.Color(255, 226, 187));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1487, 14, -1, -1));

        jLabel2.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 226, 187));
        jLabel2.setText("Bill ID : ");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 120, 70, -1));

        jLabel3.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("--");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 120, 37, -1));
        ...
        jLabel5.setForeground(new java.awt.Color(255, 226, 187));
        jLabel5.setText("Name");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 297, 61, -1));

        txtCusName.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        txtCusName.setForeground(new java.awt.Color(102, 51, 0));
        ...
        getContentPane().add(txtCusName, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 340, 285, -1));

        jLabel6.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 226, 187));
        jLabel6.setText("Mobile Number");
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 425, -1, -1));

        txtCusMobileNo.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        txtCusMobileNo.setForeground(new java.awt.Color(102, 51, 0));
        ...
        getContentPane().add(txtCusMobileNo, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 469, 285, -1));

        jLabel7.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 226, 187));
        jLabel7.setText("Email");
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 561, 61, -1));

        txtCusEmail.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        txtCusEmail.setForeground(new java.awt.Color(102, 51, 0));
        txtCusEmail.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtCusEmailKeyReleased(evt);
            }
        });
        getContentPane().add(txtCusEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(57, 605, 285, -1));

        jLabel8.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 226, 187));
        jLabel8.setText("Category");
        getContentPane().add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 110, 80, -1));
        ...
        getContentPane().add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 140, 270, -1));

        jLabel9.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 226, 187));
        jLabel9.setText("Search");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 200, 80, -1));

        txtSearch.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        txtSearch.setForeground(new java.awt.Color(102, 51, 0));
        txtSearch.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtSearchKeyReleased(evt);
            }
        });
        getContentPane().add(txtSearch, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 230, 270, -1));

        jTable1.setBackground(new java.awt.Color(255, 226, 187));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 340, 290, 340));

        jLabel10.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 226, 187));
        jLabel10.setText("Name");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 110, -1, -1));

        jLabel11.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(255, 226, 187));
        jLabel11.setText("Price");
        getContentPane().add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(1210, 110, -1, -1));

        jLabel12.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 226, 187));
        ...
        jLabel13.setForeground(new java.awt.Color(255, 226, 187));
        jLabel13.setText("Total");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(1210, 200, -1, -1));

        txtProName.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        txtProName.setForeground(new java.awt.Color(102, 51, 0));
        txtProName.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtProNameKeyReleased(evt);
            }
        });
        getContentPane().add(txtProName, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 140, 280, -1));

        txtProPrice.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        txtProPrice.setForeground(new java.awt.Color(102, 51, 0));
        ...
        getContentPane().add(txtProPrice, new org.netbeans.lib.awtextra.AbsoluteConstraints(1210, 140, 280, -1));

        jSpinner1.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        jSpinner1.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                jSpinner1StateChanged(evt);
            }
        });
        getContentPane().add(jSpinner1, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 230, 280, -1));

        txtProTotal.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        txtProTotal.setForeground(new java.awt.Color(102, 51, 0));
        txtProTotal.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                txtProTotalKeyReleased(evt);
            }
        });
        getContentPane().add(txtProTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(1210, 230, 280, -1));
        ...
        getContentPane().add(btnClear, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 270, -1, -1));

        btnAddToCart.setBackground(new java.awt.Color(255, 226, 187));
        btnAddToCart.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        btnAddToCart.setForeground(new java.awt.Color(102, 51, 0));
        ...
        getContentPane().add(btnAddToCart, new org.netbeans.lib.awtextra.AbsoluteConstraints(1340, 270, -1, -1));

        jTable2.setBackground(new java.awt.Color(255, 226, 187));
        ...
        getContentPane().add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 340, 620, 340));

        jLabel14.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 226, 187));
        jLabel14.setText("Grand Total : Rs.");
        getContentPane().add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 710, -1, -1));

        lblGrandTotal.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        lblGrandTotal.setForeground(new java.awt.Color(255, 226, 187));
        lblGrandTotal.setText("000");
        getContentPane().add(lblGrandTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 710, -1, -1));

        btnGenerateBillPrint.setBackground(new java.awt.Color(255, 226, 187));
        btnGenerateBillPrint.setFont(new java.awt.Font("Segoe Print", 1, 14)); // NOI18N
        btnGenerateBillPrint.setForeground(new java.awt.Color(102, 51, 0));
        ...
        getContentPane().add(btnGenerateBillPrint, new org.netbeans.lib.awtextra.AbsoluteConstraints(1280, 700, -1, -1));

        jLabel15.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/aaa.png"))); // NOI18N
...
//        productTotal+=productPrice;
    ...
    private void btnGenerateBillPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerateBillPrintActionPerformed
        ...
        try {
            ...
            doc.open();
            Paragraph cafeName = new Paragraph("                                                                                       Cafe & Restro Management System \n\n\n");
            doc.add(cafeName);
            Paragraph starLine = new Paragraph("----------------------------------------------------------------------------------------------------------------------- \n\n");
            doc.add(starLine);
            Paragraph paragraph3 = new Paragraph("\t Bill ID : " + billId + " \n\n Customer Name : " + customerName + "\n\n Customer Email : " + customerEmail + "\n\n Customer MobileNo. : " + customerMobileNumber + "\n\n\t\t\t\t Total Paid : " + grandTotal + "\n\n\n");
            doc.add(paragraph3);
            doc.add(starLine);
            ...
            doc.add(tb1);
            doc.add(starLine);
            Paragraph thanks = new Paragraph("\t\t\t\t Thank You, Please Visit Us Again. ");
            doc.add(thanks);
    ...
    public void validateField() {
        ...
        int productQuantity = (Integer) jSpinner1.getValue();
        String productTotal = txtProTotal.getText();
